...
coverage atlas used by `OaTextAtlas`. It retains the historical script name so
existing developer commands fail visibly rather than selecting two competing
generators.
...
python3 tools/fontAtlas/generate_sdf_atlas.py \
  --sans-font Asset/Font/IBMPlexSans/IBMPlexSans-Regular.ttf \
  --mono-font Asset/Font/IntelOneMono/IntelOneMono-Regular.ttf \
  --output source/private/oa/ui/generated/textCoverageAtlas.inc
```
