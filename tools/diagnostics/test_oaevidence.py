...
"""
    ...
    def test_records_exact_explicit_validation_layer_files(self) -> None:
        ...
        with mock.patch.dict(
            ...
            provenance = oaevidence._explicit_validation_layer_provenance()
    ...
    def test_rejects_bare_explicit_layer_without_library_path(self) -> None:
        ...
        with mock.patch.dict(
            ...
            with self.assertRaisesRegex(RuntimeError, "set LD_LIBRARY_PATH"):
                oaevidence._explicit_validation_layer_provenance()

    def test_resolves_manifest_relative_validation_layer_library(self) -> None:
