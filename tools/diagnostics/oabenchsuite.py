...
def _write_roofline_summary(
    ...
    *,
    ...
    if copy_gbps <= 0.0 or compute_gflops <= 0.0:
    ...
    summary = {
        ...
        "ceilings": {
            "delivered_fp32_gflops": compute_gflops,
            "copy_effective_gbps": copy_gbps,
            "ridge_point_flop_per_algorithmic_byte": compute_gflops / copy_gbps,
        },
        "interpretation": {
    ...
    path = output_dir / "device-roofline.json"
...
def run(args: argparse.Namespace) -> int:
    ...
    if failures:
        return 1
    roofline = _write_roofline_summary(
        completed, platform_identity=identity, output_dir=output_dir
    )
