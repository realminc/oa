	...
	def test_checked_in_ml_schema_is_complete(self) -> None:
		...
		self.assertEqual(
			...
			[
				...
				"lunar_lander_step",
				"rms_norm_gated",
				"rms_norm_gated_backward",
				"mamba3_preprocess",
				"mamba3_preprocess_backward",
				"mamba3_preprocess_backward_reduce",
				"mamba3_siso",
				...
				"mamba3_mimo",
				"mamba3_mimo_backward",
				"mamba3_mimo_step",
				"mamba3_mimo_backward_prepare",
				"mamba3_mimo_backward_post",
				"mamba3_mimo_backward_rotate",
				"mamba3_mimo_backward_reduce",
				"mamba3_siso_backward_generic",
				"mamba3_siso_backward_generic_reduce",
				"mamba3_siso_chunk_summary",
				"mamba3_siso_chunk_prefix",
				"mamba3_siso_chunk_dpre",
				"mamba3_siso_chunk_backward_summary",
				"mamba3_siso_chunk_backward_prefix",
				"mamba3_siso_chunk_backward",
				"mamba3_siso_chunk_finalize",
				"mamba3_siso_chunk_reduce",
				"vq_assign",
				"vq_lookup",
				"vq_ema_update",
			],
