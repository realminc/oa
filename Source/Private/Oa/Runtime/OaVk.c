...
void OaVkFinalize(void)
{
	...
	OaVkGenLoadInstance(NULL, nullProcAddrStub);
	OaVkGenLoadDevice(NULL, nullProcAddrStub);
...
void OaVkLoadInstance(VkInstance instance)
{
	loadedInstance = instance;
	OaVkGenLoadInstance(instance, vkGetInstanceProcAddrStub);
	OaVkGenLoadDevice(instance, vkGetInstanceProcAddrStub);

	/* Vulkan 1.1 promotion aliases for 1.0 Android HALs with KHR support. */
	if (!vkGetPhysicalDeviceFeatures2 && vkGetPhysicalDeviceFeatures2KHR)
		vkGetPhysicalDeviceFeatures2 = (PFN_vkGetPhysicalDeviceFeatures2)vkGetPhysicalDeviceFeatures2KHR;
	if (!vkGetPhysicalDeviceProperties2 && vkGetPhysicalDeviceProperties2KHR)
		vkGetPhysicalDeviceProperties2 = (PFN_vkGetPhysicalDeviceProperties2)vkGetPhysicalDeviceProperties2KHR;
	if (!vkGetPhysicalDeviceMemoryProperties2 && vkGetPhysicalDeviceMemoryProperties2KHR)
		vkGetPhysicalDeviceMemoryProperties2 = (PFN_vkGetPhysicalDeviceMemoryProperties2)vkGetPhysicalDeviceMemoryProperties2KHR;
	if (!vkGetPhysicalDeviceQueueFamilyProperties2 && vkGetPhysicalDeviceQueueFamilyProperties2KHR)
		vkGetPhysicalDeviceQueueFamilyProperties2 = (PFN_vkGetPhysicalDeviceQueueFamilyProperties2)vkGetPhysicalDeviceQueueFamilyProperties2KHR;
}

void OaVkLoadInstanceOnly(VkInstance instance)
{
	loadedInstance = instance;
	OaVkGenLoadInstance(instance, vkGetInstanceProcAddrStub);
}

VkInstance OaVkGetLoadedInstance(void)
{
	return loadedInstance;
}

void OaVkLoadDevice(VkDevice device)
{
	loadedDevice = device;
	OaVkGenLoadDevice(device, vkGetDeviceProcAddrStub);
	...
	if (!vkGetBufferMemoryRequirements2 && vkGetBufferMemoryRequirements2KHR)
		vkGetBufferMemoryRequirements2 = (PFN_vkGetBufferMemoryRequirements2)vkGetBufferMemoryRequirements2KHR;
	if (!vkGetImageMemoryRequirements2 && vkGetImageMemoryRequirements2KHR)
		vkGetImageMemoryRequirements2 = (PFN_vkGetImageMemoryRequirements2)vkGetImageMemoryRequirements2KHR;
	if (!vkBindBufferMemory2 && vkBindBufferMemory2KHR)
		vkBindBufferMemory2 = (PFN_vkBindBufferMemory2)vkBindBufferMemory2KHR;
	if (!vkBindImageMemory2 && vkBindImageMemory2KHR)
		vkBindImageMemory2 = (PFN_vkBindImageMemory2)vkBindImageMemory2KHR;
	if (!vkGetBufferDeviceAddress && vkGetBufferDeviceAddressKHR)
		vkGetBufferDeviceAddress = (PFN_vkGetBufferDeviceAddress)vkGetBufferDeviceAddressKHR;
	if (!vkGetSemaphoreCounterValue && vkGetSemaphoreCounterValueKHR)
		vkGetSemaphoreCounterValue = (PFN_vkGetSemaphoreCounterValue)vkGetSemaphoreCounterValueKHR;
	if (!vkSignalSemaphore && vkSignalSemaphoreKHR)
		vkSignalSemaphore = (PFN_vkSignalSemaphore)vkSignalSemaphoreKHR;
	if (!vkWaitSemaphores && vkWaitSemaphoresKHR)
		vkWaitSemaphores = (PFN_vkWaitSemaphores)vkWaitSemaphoresKHR;
	if (!vkCmdPipelineBarrier2 && vkCmdPipelineBarrier2KHR)
		vkCmdPipelineBarrier2 = (PFN_vkCmdPipelineBarrier2)vkCmdPipelineBarrier2KHR;
	if (!vkCmdWriteTimestamp2 && vkCmdWriteTimestamp2KHR)
		vkCmdWriteTimestamp2 = (PFN_vkCmdWriteTimestamp2)vkCmdWriteTimestamp2KHR;
	if (!vkQueueSubmit2 && vkQueueSubmit2KHR)
		vkQueueSubmit2 = (PFN_vkQueueSubmit2)vkQueueSubmit2KHR;
	if (!vkCmdBeginRendering && vkCmdBeginRenderingKHR)
		vkCmdBeginRendering = (PFN_vkCmdBeginRendering)vkCmdBeginRenderingKHR;
	if (!vkCmdEndRendering && vkCmdEndRenderingKHR)
		vkCmdEndRendering = (PFN_vkCmdEndRendering)vkCmdEndRenderingKHR;
}

VkDevice OaVkGetLoadedDevice(void)
{
	return loadedDevice;
}
...
{
	/* vkGetDeviceProcAddr is used by OaVkLoadDeviceTable; for now we load this global pointer even though it might be instance-specific */
...
void OaVkLoadDeviceTable(struct OaVkDeviceTable* table, VkDevice device)
{
	memset(table, 0, sizeof(*table));
	OaVkGenLoadDeviceTable(table, device, vkGetDeviceProcAddrStub);
}
