...
void BindVisionImage(nb::module_& m) {
    ...
    m.def("InRange", [](const OaMatrix& image, OaF32 low, OaF32 high, OaF32 true_value) {
       ...
       nb::arg("TrueValue") = 1.0F, nb::rv_policy::take_ownership);
    ...
    m.def("BrightnessContrast", [](const OaImage& image, OaF32 brightness, OaF32 contrast) {
        return image_ptr(OaFnImage::BrightnessContrast(image, brightness, contrast));
    }, nb::arg("Image"), nb::arg("Brightness") = 0.0F,
       nb::arg("Contrast") = 1.0F, nb::rv_policy::take_ownership);
    ...
    m.def("Solarize", [](const OaMatrix& image, OaF32 threshold, OaF32 max_value) {
       ...
       nb::arg("MaxValue") = 1.0F, nb::rv_policy::take_ownership);
    ...
    m.def("SaltPepperNoise", [](const OaMatrix& image, OaF32 probability,
       ...
       nb::arg("SaltValue") = 1.0F, nb::arg("PepperValue") = 0.0F,
       nb::arg("Seed") = 0, nb::rv_policy::take_ownership);
    ...
    m.def("Convolve2d", [](const OaMatrix& image, const OaMatrix& kernel,
       ...
       nb::arg("BorderValue") = 0.0F, nb::rv_policy::take_ownership);
    ...
    }, nb::arg("Image"), nb::arg("KernelX"), nb::arg("KernelY"),
       nb::arg("Border") = OaBorderMode::Reflect101,
       nb::arg("BorderValue") = 0.0F, nb::rv_policy::take_ownership);
    ...
    }, nb::arg("Image"), nb::arg("KernelWidth") = 3,
       nb::arg("KernelHeight") = 3,
       nb::arg("Border") = OaBorderMode::Reflect101,
       nb::rv_policy::take_ownership);
    ...
    }, nb::arg("Image"), nb::arg("KernelSize") = 3,
       nb::arg("Border") = OaBorderMode::Reflect101,
       nb::rv_policy::take_ownership);
    ...
    }, nb::arg("Image"), nb::arg("KernelSize") = 5,
       nb::arg("SigmaColor") = 0.1F, nb::arg("SigmaSpace") = 1.0F,
       nb::arg("Border") = OaBorderMode::Reflect101,
       nb::rv_policy::take_ownership);
    m.def("UnsharpMask", [](const OaMatrix& image, OaF32 sigma,
       ...
       nb::arg("Amount") = 1.0F, nb::arg("KernelSize") = 0,
       nb::rv_policy::take_ownership);
    m.def("MorphologyTopHat", [](const OaMatrix& image, OaU32 kernel_width,
       ...
       nb::arg("KernelHeight") = 3, nb::arg("Border") = OaBorderMode::Reflect101,
       nb::arg("BorderValue") = 0.0F, nb::rv_policy::take_ownership);
    ...
    }, nb::arg("Image"), nb::arg("KernelSize") = 11, nb::arg("C") = 0.0F,
       nb::arg("MaxValue") = 1.0F, nb::arg("Border") = OaBorderMode::Reflect101,
       nb::rv_policy::take_ownership);
    m.def("AdaptiveThresholdGaussian", [](const OaMatrix& image, OaU32 kernel_size,
       ...
       nb::arg("MaxValue") = 1.0F, nb::arg("Sigma") = 0.0F,
       nb::arg("Border") = OaBorderMode::Reflect101,
       nb::rv_policy::take_ownership);
