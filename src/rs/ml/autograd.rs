...
pub(in crate::ml) use matrix::{
	record_adaptive_avg_pool_2d, record_avg_pool_2d, record_batch_norm_2d, record_bmm, record_bmm_nt,
	record_bmm_tn, record_channel_norm, record_conv_1d, record_conv_2d, record_conv_transpose_1d,
	...
	record_layer_norm, record_leaky_relu, record_linear, record_mamba3_mimo,
	record_mamba3_preprocess, record_mamba3_siso, record_max_pool_2d, record_merge_heads,
	record_mish, record_moe_combine, record_moe_gather, record_moe_route_weights, record_relu,
	record_rms_norm, record_rms_norm_gated, record_rnn_cell, record_rnn_scan, record_rope,
	record_scaled_dot_product_attention, record_sigmoid, record_silu, record_silu_mul,
