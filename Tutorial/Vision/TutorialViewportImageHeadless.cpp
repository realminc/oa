// ═══════════════════════════════════════════════════════════════════════════
// OA Tutorial: OaViewport — Batch Mode (SaveImage sink)
// Level 0 API — Headless engine + OaFnImage::SaveFile
// ═══════════════════════════════════════════════════════════════════════════
//
// The front/back end split in code (UnifiedExecutionArchitecture.md §3.5).
//
...
// TutorialViewport) the sink is Present(swapchain, target). Here the sink is
...
//
// Usage:
//   ./TutorialViewportBatch [input.jpg] [output.png]
//
...
int main(int argc, char** argv) {
	...
	OA_LOG_INFO(OaLogComponent::App,
		"TutorialViewportBatch: %s → %s", inPath, outPath);
	...
	// ─── Sink: SaveImage (UnifiedExecutionArchitecture.md §3.5) ─────────────────────────────────
