...
fn main() -> oa::Result<()> {
	_bpe_common::run(
		_bpe_common::Tutorial {
			...
			learning_rate: 0.003,
			expected_loss: oa::sdk::ml::nlp::BPE_MAMBA3_FINAL_LOSS,
			expected_accuracy: oa::sdk::ml::nlp::BPE_MAMBA3_ACCURACY,
			expected_generation: oa::sdk::ml::nlp::BPE_MAMBA3_REFERENCE_GENERATION,
		},
		oa::sdk::ml::nlp::BpeMamba3::new,
	)
}
