...
fn main() -> oa::Result<()> {
	bpe_common::run(
		bpe_common::Tutorial {
			...
			learning_rate: 0.01,
			expected_loss: oa::ml::nlp::BPE_MOE_FINAL_LOSS,
			expected_accuracy: oa::ml::nlp::BPE_MOE_ACCURACY,
			expected_generation: oa::ml::nlp::BPE_MOE_REFERENCE_GENERATION,
		},
		oa::ml::nlp::BpeMoeTransformer::new,
	)
}
