...
fn main() -> oa::Result<()> {
	byte_common::run(
		byte_common::Tutorial {
			...
			learning_rate: 0.003,
			expected_loss: oa::ml::nlp::BYTE_EMPYREALM_FINAL_LOSS,
			expected_accuracy: oa::ml::nlp::BYTE_EMPYREALM_ACCURACY,
			expected_generation: oa::ml::nlp::BYTE_EMPYREALM_REFERENCE_GENERATION,
		},
		oa::ml::nlp::ByteEmpyrealm::new,
	)
}
