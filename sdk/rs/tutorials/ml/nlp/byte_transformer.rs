...
fn main() -> oa::Result<()> {
	byte_common::run(
		byte_common::Tutorial {
			...
			learning_rate: 0.01,
			expected_loss: oa::ml::nlp::BYTE_TRANSFORMER_FINAL_LOSS,
			expected_accuracy: oa::ml::nlp::BYTE_TRANSFORMER_ACCURACY,
			expected_generation: oa::ml::nlp::BYTE_TRANSFORMER_REFERENCE_GENERATION,
		},
		oa::ml::nlp::ByteTransformer::new,
	)
}
