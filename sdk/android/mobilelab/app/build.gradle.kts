...
val turnipAssetsDirectory =
	oaRootDirectory.resolve("build/sdk/android/mobilelab/assets")
	...
	externalNativeBuild {
		cmake {
			...
			buildStagingDirectory = oaRootDirectory.resolve(
				"build/sdk/android/mobilelab/cmake")
		}
	}
}
...
listOf("debug", "release").forEach { buildType ->
	...
	val stageApk = tasks.register<Copy>("stage${buildTypeName}Apk") {
		...
		include("*.apk")
		into(oaRootDirectory.resolve("bin/$buildType/sdk/android/mobilelab"))
		rename { "oaMobileLab.apk" }
	}
