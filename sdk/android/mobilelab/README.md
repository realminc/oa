...
git submodule update --init --recursive \
	sdk/android/mobilelab/third_party/libadrenotools
```
...
```text
build/sdk/android/mobilelab/gradle/     Gradle intermediates and reports
build/sdk/android/mobilelab/cmake/      NDK/CMake/Ninja intermediates
build/sdk/android/mobilelab/assets/     verified generated Turnip and staged SDK assets
bin/{debug,release}/sdk/android/mobilelab/  installable APKs by build variant
```

Build from the app directory:

```bash
cd sdk/android/mobilelab
...
```bash
adb install -r ../../../bin/debug/sdk/android/mobilelab/oaMobileLab.apk
```
...
"$ANDROID_HOME/build-tools/36.0.0/apksigner" verify --verbose \
	../../../bin/release/sdk/android/mobilelab/oaMobileLab.apk
adb install -r ../../../bin/release/sdk/android/mobilelab/oaMobileLab.apk
```
