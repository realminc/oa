    ...
    OaVmaVulkanFunctions* OA_VMA_NOT_NULL pDstVulkanFunctions)
{
    ...
    OaVkInstanceTable instance = {};
    oaVkLoadInstanceTable(&instance, pAllocatorCreateInfo->instance);
    OaVkDeviceTable src = {};
    oaVkLoadDeviceTable(&src, &instance, pAllocatorCreateInfo->device);
...
#define COPY_INSTANCE_TO_OA_VMA_FUNC(volkName, OaVmaName) if(!pDstVulkanFunctions->OaVmaName) pDstVulkanFunctions->OaVmaName = instance.volkName;
#define COPY_DEVICE_TO_OA_VMA_FUNC(volkName, OaVmaName) if(!pDstVulkanFunctions->OaVmaName) pDstVulkanFunctions->OaVmaName = src.volkName;
    ...
    COPY_GLOBAL_TO_OA_VMA_FUNC(oaVkGetInstanceProcAddr(), vkGetInstanceProcAddr)
    COPY_INSTANCE_TO_OA_VMA_FUNC(vkGetDeviceProcAddr, vkGetDeviceProcAddr)
    COPY_INSTANCE_TO_OA_VMA_FUNC(vkGetPhysicalDeviceProperties, vkGetPhysicalDeviceProperties)
    COPY_INSTANCE_TO_OA_VMA_FUNC(vkGetPhysicalDeviceMemoryProperties, vkGetPhysicalDeviceMemoryProperties)
    ...
    {
        COPY_INSTANCE_TO_OA_VMA_FUNC(vkGetPhysicalDeviceMemoryProperties2, vkGetPhysicalDeviceMemoryProperties2KHR)
    ...
    {
        COPY_INSTANCE_TO_OA_VMA_FUNC(vkGetPhysicalDeviceMemoryProperties2KHR, vkGetPhysicalDeviceMemoryProperties2KHR)
    }
#endif
...
#undef COPY_INSTANCE_TO_OA_VMA_FUNC
