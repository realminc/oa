...
void oaVkLoadInstanceTable(struct OaVkInstanceTable* table, VkInstance instance)
{
	...
	if (!table->vkGetPhysicalDeviceFeatures2 && table->vkGetPhysicalDeviceFeatures2KHR)
		table->vkGetPhysicalDeviceFeatures2 = (PFN_vkGetPhysicalDeviceFeatures2)table->vkGetPhysicalDeviceFeatures2KHR;
	if (!table->vkGetPhysicalDeviceProperties2 && table->vkGetPhysicalDeviceProperties2KHR)
		table->vkGetPhysicalDeviceProperties2 = (PFN_vkGetPhysicalDeviceProperties2)table->vkGetPhysicalDeviceProperties2KHR;
	if (!table->vkGetPhysicalDeviceMemoryProperties2 && table->vkGetPhysicalDeviceMemoryProperties2KHR)
		table->vkGetPhysicalDeviceMemoryProperties2 = (PFN_vkGetPhysicalDeviceMemoryProperties2)table->vkGetPhysicalDeviceMemoryProperties2KHR;
	if (!table->vkGetPhysicalDeviceQueueFamilyProperties2 && table->vkGetPhysicalDeviceQueueFamilyProperties2KHR)
	...
	VkDevice device)
{
	...
	if (!table->vkGetBufferMemoryRequirements2 && table->vkGetBufferMemoryRequirements2KHR)
		table->vkGetBufferMemoryRequirements2 = (PFN_vkGetBufferMemoryRequirements2)table->vkGetBufferMemoryRequirements2KHR;
	if (!table->vkGetImageMemoryRequirements2 && table->vkGetImageMemoryRequirements2KHR)
		table->vkGetImageMemoryRequirements2 = (PFN_vkGetImageMemoryRequirements2)table->vkGetImageMemoryRequirements2KHR;
	if (!table->vkBindBufferMemory2 && table->vkBindBufferMemory2KHR)
		table->vkBindBufferMemory2 = (PFN_vkBindBufferMemory2)table->vkBindBufferMemory2KHR;
	if (!table->vkBindImageMemory2 && table->vkBindImageMemory2KHR)
		table->vkBindImageMemory2 = (PFN_vkBindImageMemory2)table->vkBindImageMemory2KHR;
	if (!table->vkGetBufferDeviceAddress && table->vkGetBufferDeviceAddressKHR)
		table->vkGetBufferDeviceAddress = (PFN_vkGetBufferDeviceAddress)table->vkGetBufferDeviceAddressKHR;
	if (!table->vkGetSemaphoreCounterValue && table->vkGetSemaphoreCounterValueKHR)
		table->vkGetSemaphoreCounterValue = (PFN_vkGetSemaphoreCounterValue)table->vkGetSemaphoreCounterValueKHR;
	if (!table->vkSignalSemaphore && table->vkSignalSemaphoreKHR)
		table->vkSignalSemaphore = (PFN_vkSignalSemaphore)table->vkSignalSemaphoreKHR;
	if (!table->vkWaitSemaphores && table->vkWaitSemaphoresKHR)
		table->vkWaitSemaphores = (PFN_vkWaitSemaphores)table->vkWaitSemaphoresKHR;
	if (!table->vkCmdPipelineBarrier2 && table->vkCmdPipelineBarrier2KHR)
		table->vkCmdPipelineBarrier2 = (PFN_vkCmdPipelineBarrier2)table->vkCmdPipelineBarrier2KHR;
	if (!table->vkCmdWriteTimestamp2 && table->vkCmdWriteTimestamp2KHR)
		table->vkCmdWriteTimestamp2 = (PFN_vkCmdWriteTimestamp2)table->vkCmdWriteTimestamp2KHR;
	if (!table->vkQueueSubmit2 && table->vkQueueSubmit2KHR)
		table->vkQueueSubmit2 = (PFN_vkQueueSubmit2)table->vkQueueSubmit2KHR;
	if (!table->vkCmdBeginRendering && table->vkCmdBeginRenderingKHR)
		table->vkCmdBeginRendering = (PFN_vkCmdBeginRendering)table->vkCmdBeginRenderingKHR;
	if (!table->vkCmdEndRendering && table->vkCmdEndRenderingKHR)
